    ...
    <div class="card-body">
        <div class="table-responsive">
            <form action="/admin/giay/them" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                    <input type="input" class="form-control" name="size1" required />
                    <label class="form-label">nhập size giày từ</label>
                </div>
                <div class="form-outline mb-4">
                    <input type="input" class="form-control" name="size2" required />
                    <label class="form-label"> đến size</label>
                </div>

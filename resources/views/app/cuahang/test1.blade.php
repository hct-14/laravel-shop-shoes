...
.selected {
    ...
    <script>
        function submitForm() {
            ...
            var selectedPaymentMethod = $("input[name='httt_ma']:checked").val();

            // Gửi dữ liệu lên server bằng AJAX
            $.ajax({
                type: 'POST',
                url: 'your_controller.php', // Đường dẫn đến controller của bạn
                data: { size: selectedSize, paymentMethod: selectedPaymentMethod },

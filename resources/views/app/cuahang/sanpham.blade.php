...
.size-item {
    ...
    cursor: pointer; /* Biến con trỏ thành bàn tay khi di chuột vào ô */
}

.selected {
    background-color: #aaffaa; /* Màu nền khi ô được chọn */
}
        </style>
    <div class="container">
        <br>
            ...
            <div class="card mb-3">
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{ url('/cua-hang/san-pham=' . $giay['id_giay'] . '/them') }}" method="GET">
                            @csrf
                            <b>SIZE:</b>
                            ...
                            <p class="card-text"><b>Loại giày:</b> {{ $giay['ten_loai_giay'] }}&emsp;<i class="fab fa-squarespace"></i>&emsp; <b>Thương hiệu:</b>
                            ...
                            <button class="btn btn-info" type="submit" value="Đặt Hàng" name="btnDatHang">Thêm vào giỏ hàng</button>

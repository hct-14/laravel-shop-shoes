...
<head>
    ...
    <title>GIAPHU SHOP</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL('images1/logo-giaphu.jpg') }}">
...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/logo-giaphu.jpg') }}" height="45" alt="SHOP"
                    loading="lazy"></a>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2021 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp;GIAPHU SHOP</a>
                </span>
            </div>
        </section>
    </footer>
